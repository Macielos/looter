...
import com.looter.entities.Event;
...
@Api(name = "eventendpoint", namespace = @ApiNamespace(ownerDomain = "looter.com", ownerName = "looter.com", packagePath = "entities") )
public class EventEndpoint {
	...
	public CollectionResponse<Event> listEvent(@Nullable @Named("cursor") String cursorString,
		...
		return CollectionResponse.<Event> builder().setItems(execute).setNextPageToken(cursorString).build();
	}
