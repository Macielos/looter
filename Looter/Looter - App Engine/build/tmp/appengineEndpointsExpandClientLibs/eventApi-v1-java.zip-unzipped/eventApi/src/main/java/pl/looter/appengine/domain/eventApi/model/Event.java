...
public final class Event extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<EventParticipation> participants;

  static {
    // hack to force ProGuard to consider EventParticipation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(EventParticipation.class);
  }
  ...
  /**
   * @param masterId masterId or {@code null} for none
   */
  public Event setMasterId(java.lang.Long masterId) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<EventParticipation> getParticipants() {
    return participants;
  }
   ...
   */
  public Event setParticipants(java.util.List<EventParticipation> participants) {
