...
package pl.looter.appengine.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<pl.looter.appengine.registration.model.CollectionResponseUser> {

    private static final String REST_PATH = "user/{count}";
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, pl.looter.appengine.registration.model.CollectionResponseUser.class);
